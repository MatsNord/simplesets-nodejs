...
(function() {
    ...
    sets.Set.prototype = SetPrototype;
...
// type, not StringSet.
    ...
    sets.StringSet.prototype = StringSetPrototype;
    window.sets = sets;
}());